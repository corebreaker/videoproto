...
const uint8_t configDescriptor1[]={
    ...
    10,                            // Max power consumption (2mA/unit)
...
const struct{uint8_t bLength;uint8_t bDscType;uint16_t string[2];}sd000={
sizeof(sd000),USB_DESCRIPTOR_STRING,{0x0409, 0x040C}};

//Manufacturer string descriptor
const struct{uint8_t bLength;uint8_t bDscType;uint16_t string[11];}sd001={
sizeof(sd001),USB_DESCRIPTOR_STRING,
{'C','o','r','e','b','r','e','a','k','e','r'}
};

//Product string descriptor
const struct{uint8_t bLength;uint8_t bDscType;uint16_t string[17];}sd002={
sizeof(sd002),USB_DESCRIPTOR_STRING,
{'X','S','t','a','r',' ','P','r','o','t','o',' ','V','i','d','e','o'}
};
...
const struct{uint8_t bLength;uint8_t bDscType;uint16_t string[19];}sd004={
sizeof(sd004),USB_DESCRIPTOR_STRING,
{'V','i','d','e','o',' ','C','o','n','f','i','g','u','r','a','t','i','o','n'}
};

const struct{uint8_t bLength;uint8_t bDscType;uint16_t string[7];}sd005={
