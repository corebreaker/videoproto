...
#define USB_NUM_STRING_DESCRIPTORS 6  //Set this number to match the total number of string descriptors that are implemented in the usb_descriptors.c file
